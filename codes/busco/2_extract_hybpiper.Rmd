...
sptree$edge.length <- rep(1, nrow(sptree$edge))
...
df_output_quibl <- foreach (i = 1:nrow(df_quibl_metadata), .combine='rbind') %dopar% {
    ...
    f_quibl(paste0(temp_outdir_quibl, "quibl.txt"), exe_quibl)
    ...
    f_quibl(paste0(temp_outdir_quibl, "quibl_transformed.txt"), exe_quibl)
