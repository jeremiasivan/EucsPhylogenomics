...
foreach(busco = ls_busco) %dopar% {
    ...
    f_x2gap(fn_in_fa, fn_n2gap_fa)
    f_remove_seq(fn_n2gap_fa, fn_rmSeq_fa, 0.5)
...
df_output_quibl <- foreach (i = 1:nrow(df_quibl_metadata), .combine='rbind') %dopar% {
    ...
    writeLines(ls_dist, con=paste0(temp_outdir_quibl, "all_dist.txt"))
    ...
    writeLines(ls_dist_transformed, con=paste0(temp_outdir_quibl, "all_transformed_dist.txt"))

    # visualisation
    plot <- gpplot() +
        geom_density(x=ls_dist, colour="blue") +
        geom_density(x=ls_dist_transformed, colour="blue")
    ...
    write.table(c("[Input]",
                ...
                file=paste0(temp_outdir_quibl, "quibl.txt"))
    ...
    write.table(c("[Input]",
                ...
                file=paste0(temp_outdir_quibl, "quibl_transformed.txt"))
    ...
    return(data.table::data.table(species_one=df_quibl_metadata$species_one[i],
                                  ...
                                  quibl_mixprop2=df_quibl$mixprop2[df_quibl$outroup==df_quibl_metadata$species_three[i]],
                                  quibl_count=df_quibl$count[df_quibl$outroup==df_quibl_metadata$species_three[i]],
                                  quibl_transformed_mixprop2=df_quibl_transformed$mixprop2[df_quibl_transformed$outroup==df_quibl_metadata$species_three[i]],
                                  quibl_transformed_count=df_quibl_transformed$count[df_quibl_transformed$outroup==df_quibl_metadata$species_three[i]]
    ))
}
