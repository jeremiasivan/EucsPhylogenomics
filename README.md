...
2. **Install the prerequisites** <br>
    ...
    - Installing prerequisites
        ```
        conda install r-ape r-data.table r-doSNOW r-log4r r-optparse r-rmarkdown r-tidyverse r-yaml aster bcftools bwa captus fasttree iqtree mafft samtools whatshap
        ```

---
*Last update: 19 June 2026 by Jeremias Ivan*